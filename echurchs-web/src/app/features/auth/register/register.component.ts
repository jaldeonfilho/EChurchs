...
@Component({
  ...
  template: `
    <div class="register-container">
      <h2>Criar Conta</h2>
      <p class="subtitle">Ligue-se à sua comunidade de fé</p>
      <form (ngSubmit)="onSubmit()">
        ...
        <div class="form-group">
          <label>Senha</label>
          <input type="password" [(ngModel)]="password" name="password" placeholder="Mínimo 6 caracteres" required>
        </div>
        <div class="form-group">
          <label>Confirmar senha</label>
          <input type="password" [(ngModel)]="confirmPassword" name="confirmPassword" placeholder="Repita a senha" required>
        </div>
      ...
      <p class="link">Já tem conta? <a routerLink="/auth/login">Entrar</a></p>
    </div>
  `,
  styles: [`

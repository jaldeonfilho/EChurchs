...
public class ApiResponseDto<T>
{
    ...
    public static ApiResponseDto<T> Fail(string message, List<string>? errors = null) => new()
    {
        Success = false,
        Message = message,
        Errors = errors
    ...
    public static ApiResponseDto<T> ErrorResponse(string message, List<string>? errors = null) => Fail(message, errors);
}
